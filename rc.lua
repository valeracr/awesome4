...
--awful.tag.seticon("/home/valera/sharingan-icons-1.5/png/16/1.png", screen[s].tags[1])
--awful.tag.seticon("/home/valera/sharingan-icons-1.5/png/16/2.png", screen[s].tags[2])
--awful.tag.seticon("/home/valera/sharingan-icons-1.5/png/16/3.png", screen[s].tags[3])
--awful.tag.seticon("/home/valera/sharingan-icons-1.5/png/16/4.png", screen[s].tags[4])
--awful.tag.seticon("/home/valera/sharingan-icons-1.5/png/16/5.png", screen[s].tags[5])
end)
------------------------
...
awful.rules.rules = {
   ...
   { rule = { class = "Deadbeef" },
    ...
    { rule = { class = "Run.py" },
     properties = { border_width = 0, geometry = { x = 1043, y = 436, width = 247, height = 270 } } },
    { rule = { class = "Tor Browser" },
