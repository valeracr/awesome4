...
local width         = 30        -- width in pixels of progressbar
local margin_right  = 0         -- right margin in pixels of progressbar
local margin_left   = 0         -- left margin in pixels of progressbar
local margin_top    = 7        -- top margin in pixels of progressbar
local margin_bottom = 7         -- bottom margin in pixels of progressbar
local step          = 0.05      -- stepsize for volume change (ranges from 0 to 1)
local color         = '#e65117' -- foreground color of progessbar
local color_bg      = '#532a15' -- background color
local color_mute    = '#e81616' -- foreground color when muted
