...
local calendar = { text_color = theme.fg_normal or "#e65117",
                   today_color = theme.fg_focus or "#2bef0a",
                   font = theme.font or 'odstemplik Bold 12' }
   ...
   utility.add_hover_tooltip(
      w, function(w)
         ...
         return { title = header,
                  ...
                  icon = '/home/valera/.icons/awoken/', icon_size = 48 }
   end)
end
