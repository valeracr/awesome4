...
function iconic.lookup_icon(icon_file, args)
   ...
   if icon_file:sub(1, 1) == '/' and is_format_supported(icon_file) then
      ...
      if icon_theme then
         table.insert(icon_theme_paths, '/home/valera/.icons/' .. icon_theme .. '/')
      end
      table.insert(icon_theme_paths, '/home/valera/.icons/hicolor/') -- fallback theme
      ...
      table.insert(icon_path, '/home/valera/.icons/')
